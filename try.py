...
def align_image(src1, src2, warp_mode=cv2.MOTION_TRANSLATION):
    ...
    (cc, warp_matrix) = cv2.findTransformECC(img1_gray, img2_gray, warp_matrix, warp_mode, criteria, inputMask=None,
                                             gaussFiltSize=1)
...
cv2.rectangle(img1_aligned_cpy, (matchArea1[0], matchArea1[1]),
              (matchArea1[0] + matchArea1[2], matchArea1[1] + matchArea1[3]), (0, 255, 0), 2)
...
cv2.rectangle(img3_aligned_cpy, (matchArea3[0], matchArea3[1]),
              (matchArea3[0] + matchArea3[2], matchArea3[1] + matchArea3[3]), (0, 255, 0), 2)
...
cv2.rectangle(img2_eq_cpy, (cropRect[0], cropRect[1]), (cropRect[0] + cropRect[2], cropRect[1] + cropRect[3]),
              (0, 0, 255), 2)
